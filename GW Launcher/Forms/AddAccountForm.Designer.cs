...
namespace GW_Launcher.Forms
{
	partial class AddAccountForm
	{
		...
		private void InitializeComponent()
		{
			...
			checkBoxSteamAccount = new CheckBox();
			toolTip1 = new ToolTip();
			pictureBoxSteamLogo = new PictureBox();
			((System.ComponentModel.ISupportInitialize)pictureBoxSteamLogo).BeginInit();
			SuspendLayout();
			// 
			// labelEmail
			// 
			labelEmail.AutoSize = true;
			labelEmail.Location = new Point(23, 74);
			...
			// textBoxEmail
			// 
			textBoxEmail.Location = new Point(70, 71);
			...
			// textBoxPassword
			// 
			textBoxPassword.Location = new Point(70, 100);
			...
			labelPassword.Location = new Point(29, 104);
			...
			buttonDone.Location = new Point(198, 243);
			...
			labelPath.Location = new Point(28, 166);
			...
			// textBoxPath
			// 
			textBoxPath.Location = new Point(70, 162);
			...
			labelExtraArguments.Location = new Point(13, 194);
			...
			// 
			textBoxExtraArguments.Location = new Point(70, 191);
			...
			textBoxExtraArguments.TabIndex = 9;
			// 
			// buttonTogglePasswordVisibility
			// 
			buttonTogglePasswordVisibility.Location = new Point(248, 100);
			...
			buttonTogglePasswordVisibility.TabIndex = 5;
			...
			checkBoxUsePluginFolderMods.Location = new Point(115, 223);
			checkBoxUsePluginFolderMods.Name = "checkBoxUsePluginFolderMods";
			checkBoxUsePluginFolderMods.Size = new Size(167, 19);
			checkBoxUsePluginFolderMods.TabIndex = 11;
			checkBoxUsePluginFolderMods.Text = "Use mods in plugin folders";
			checkBoxUsePluginFolderMods.UseVisualStyleBackColor = true;
			// 
			// checkBoxSteamAccount
			// 
			checkBoxSteamAccount.AutoSize = true;
			checkBoxSteamAccount.Location = new Point(13, 45);
			checkBoxSteamAccount.Name = "checkBoxSteamAccount";
			checkBoxSteamAccount.Size = new Size(108, 19);
			checkBoxSteamAccount.TabIndex = 2;
			checkBoxSteamAccount.Text = "Steam Account";
			toolTip1.SetToolTip(checkBoxSteamAccount, "Tick this if you bought Guild Wars on Steam and don't have any login credentials");
			checkBoxSteamAccount.UseVisualStyleBackColor = true;
			checkBoxSteamAccount.CheckedChanged += CheckBoxSteamAccount_CheckedChanged;
			// 
			// pictureBoxSteamLogo
			// 
			pictureBoxSteamLogo.Location = new Point(70, 71);
			pictureBoxSteamLogo.Name = "pictureBoxSteamLogo";
			pictureBoxSteamLogo.Size = new Size(203, 81);
			pictureBoxSteamLogo.SizeMode = PictureBoxSizeMode.Zoom;
			pictureBoxSteamLogo.TabIndex = 18;
			pictureBoxSteamLogo.TabStop = false;
			pictureBoxSteamLogo.Visible = false;
			// 
			// AddAccountForm
			// 
			...
			Controls.Add(pictureBoxSteamLogo);
			Controls.Add(checkBoxSteamAccount);
			...
			((System.ComponentModel.ISupportInitialize)pictureBoxSteamLogo).EndInit();
			ResumeLayout(false);
			PerformLayout();
		}
		...
		private CheckBox checkBoxSteamAccount;
		private ToolTip toolTip1;
		private PictureBox pictureBoxSteamLogo;
	}
}
